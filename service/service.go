...
func New(ctx context.Context, set Settings, cfg Config) (*Service, error) {
	...
	var err error
	srv.telemetry, err = telemetry.New(ctx, telemetry.Settings{ZapOptions: set.LoggingOptions},
	...
	if err = srv.telemetryInitializer.init(res, srv.telemetrySettings, cfg.Telemetry, set.AsyncErrorChannel,
		set.OtelMetricViews, set.OtelMetricReader, set.UseExternalMetricsServer); err != nil {
...
func (srv *Service) initExtensionsAndPipeline(ctx context.Context, set Settings, cfg Config) error {
	...
	if !set.DisableProcessMetrics && cfg.Telemetry.Metrics.Level != configtelemetry.LevelNone &&
		(set.UseExternalMetricsServer || cfg.Telemetry.Metrics.Address != "") {
