...
import (
	...
	go_opentelemetry_io_collector_model_internal_data "go.opentelemetry.io/collector/model/external/data"
	v11 "go.opentelemetry.io/collector/model/external/data/protogen/common/v1"
	v1 "go.opentelemetry.io/collector/model/external/data/protogen/resource/v1"
)
...
type LogRecord struct {
	...
	TraceId go_opentelemetry_io_collector_model_internal_data.TraceID `protobuf:"bytes,9,opt,name=trace_id,json=traceId,proto3,customtype=go.opentelemetry.io/collector/model/external/data.TraceID" json:"trace_id"`
	// A unique identifier for a span within a trace, assigned when the span
	// is created. The ID is an 8-byte array. An ID with all zeroes is considered
	// invalid. Can be set for logs that are part of a particular processing span.
	// If span_id is present trace_id SHOULD be also present. [Optional].
	SpanId go_opentelemetry_io_collector_model_internal_data.SpanID `protobuf:"bytes,10,opt,name=span_id,json=spanId,proto3,customtype=go.opentelemetry.io/collector/model/external/data.SpanID" json:"span_id"`
}
...
var fileDescriptor_d1c030a3ec7e961e = []byte{
	...
	,
}
