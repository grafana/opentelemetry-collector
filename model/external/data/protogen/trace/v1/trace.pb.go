...
type Span struct {
	...
	TraceId go_opentelemetry_io_collector_model_internal_data.TraceID `protobuf:"bytes,1,opt,name=trace_id,json=traceId,proto3,customtype=go.opentelemetry.io/collector/model/external/data.TraceID" json:"trace_id"`
	...
	//
	// This field is required.
	SpanId go_opentelemetry_io_collector_model_internal_data.SpanID `protobuf:"bytes,2,opt,name=span_id,json=spanId,proto3,customtype=go.opentelemetry.io/collector/model/external/data.SpanID" json:"span_id"`
	...
	ParentSpanId go_opentelemetry_io_collector_model_internal_data.SpanID `protobuf:"bytes,4,opt,name=parent_span_id,json=parentSpanId,proto3,customtype=go.opentelemetry.io/collector/model/external/data.SpanID" json:"parent_span_id"`
