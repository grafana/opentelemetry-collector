...
package internal // import "go.opentelemetry.io/collector/cmd/builder/external"
...
import (
	...
	"go.opentelemetry.io/collector/cmd/builder/external/builder"
	"go.opentelemetry.io/collector/cmd/builder/external/config"
)
